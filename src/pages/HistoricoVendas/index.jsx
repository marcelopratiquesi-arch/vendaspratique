...
import { Filter, Calendar, CalendarDays, Sun, UserCheck, Wallet, BarChart2, Leaf, Star, Activity, Dumbbell, ShoppingBag, Receipt, Layers, ChevronDown, ChevronUp, AlertCircle, RefreshCw, AlertTriangle, Bookmark, Package, Briefcase, Zap, CheckSquare, Square } from 'lucide-react';
...
    // ==========================================
    // 🧠 MOTOR DE CASCATA (PASSO 1): FILTRO BASE (Unidade + Data)
    // ==========================================
...
    // ==========================================
    // 🧠 MOTOR DE CASCATA (PASSO 2): ALIMENTAR AS CAIXINHAS
    // ==========================================
...
    // ==========================================
    // 🧠 MOTOR DE CASCATA (PASSO 3): APLICAR A SELEÇÃO
    // ==========================================
